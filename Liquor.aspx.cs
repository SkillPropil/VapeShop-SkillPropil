...
{
    public partial class Liquor : System.Web.UI.Page
    {
        ...
        protected void IQOSbtn_Click(object sender, EventArgs e)
        {
            Response.Redirect("IQOS.aspx");
        }

        protected void Partsbtn_Click(object sender, EventArgs e)
        {
