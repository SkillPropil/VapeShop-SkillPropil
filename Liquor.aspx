<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Liquor.aspx.cs" Inherits="VapeShop_SkillPropil.Liquor" %>
...
<body style="background-position: 750px 1519px; height: 750px; width: 1519px;  background-repeat: no-repeat;">
    ...
    <form id="form1" runat="server">
        ...
        <div style="background-image: url('https://localhost:44377/liquor.AVVj2.png'); background-repeat: no-repeat; background-attachment: scroll; width: 1519px; height: 921px;">
        ...
        <asp:Button ID="Partsbtn" runat="server" Text="Комлпектующие"  BackColor="#C0C0C0" ForeColor="Black" Height="74px" Width="269px" OnClick="Partsbtn_Click" />
        <asp:Button ID="Жидкость" runat="server" Text="Жидкости"  BackColor="#696969" ForeColor="Black" Height="75px" Width="273px" />
             <br/>
             <br/>
             <br/>
             <br/>
