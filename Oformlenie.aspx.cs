...
{
    public partial class Oformlenie : System.Web.UI.Page
    {
        private string QR = "";
        ...
        protected void btInsert_Click(object sender, EventArgs e)
        {
            ...
            if (!err)
            {
                ...
                command.CommandText = "INSERT INTO [dbo].[Rent_Tickets] ([Name_of_Client],[Phone],[Vape_Model],[Client_ID],[Vape_ID],[BankCard]) values ('" + tbName.Text + "','" + tbPhone.Text + "','" + tbModel.Text + "','" + lstClient.SelectedValue +"','" + lstVape.SelectedValue + "','" + tbCard.Text + "')";
