<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MODS.aspx.cs" Inherits="VapeShop_SkillPropil.MODS" %>
...
<body style="background-position: 750px 1519px; height: 750px; width: 1519px;  background-repeat: no-repeat;">
    ...
    <form id="form1" runat="server">
        ...
        <div style="background-image: url('mods.Nhvaz.png'); background-repeat: no-repeat; background-attachment: scroll; width: 1519px; height: 921px;">
        ...
        <asp:Button ID="Mods" runat="server" Text="Моды"  BackColor="#696969" ForeColor="Black" Height="76px" Width="180px"  />
