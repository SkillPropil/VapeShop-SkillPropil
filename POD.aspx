<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POD.aspx.cs" Inherits="VapeShop_SkillPropil.POD" %>
...
<body style="background-position: 750px 1519px; height: 750px; width: 1519px;  background-repeat: no-repeat;">
    ...
    <form id="form1" runat="server">
        ...
        <div style="background-image: url('https://localhost:44377/pod.rqHKb.png'); background-repeat: no-repeat; background-attachment: scroll; width: 1519px; height: 921px;">
        ...
        <asp:Button ID="Pods" runat="server" Text="Pod-системы"  BackColor="#696969" ForeColor="Black" Height="77px" Width="271px" />
        <asp:Button ID="Mods" runat="server" Text="Моды"  BackColor="#C0C0C0" ForeColor="Black" Height="76px" Width="180px" OnClick="Mods_Click" />
        <asp:Button ID="IQOS" runat="server" Text="IQOS"  BackColor="#C0C0C0" ForeColor="Black" Height="77px" Width="150px" OnClick="IQOS_Click" />
        <asp:Button ID="Parts" runat="server" Text="Комлпектующие"  BackColor="#C0C0C0" ForeColor="Black" Height="74px" Width="269px" OnClick="Parts_Click" />
